...
public class MainActivity extends AppCompatActivity
  ...
  private void startGameTimer() {
      gameTimer = new Timer();
      gameTimer.schedule(new GameTimeoutTask(), gameDuration * 1000 - gameTimeElapsed);
  ...
  private class GameTimeoutTask extends TimerTask{
    ...
    public void run() {
      ...
      runOnUiThread(() -> {
        pauseGame();
        Toast.makeText(MainActivity.this, "Where you at, playa? Game resetting", Toast.LENGTH_LONG).show();
        showStats();
      });
    }
